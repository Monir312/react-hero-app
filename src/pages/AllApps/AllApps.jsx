  ...
  return (
    <div className='mb-5'>
      ...
      <div className='flex justify-between items-center mx-4 py-4'>
        <div className="total font-semibold text-[#001931] text-[24px]">(132) Apps Found</div>
      ...
      <Suspense fallback={<span>Loading......</span>}>
        <div className='mx-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5'>
          {
            alldata.map((allappdata) => <AllApp key={allappdata.id} allappdata={allappdata}></AllApp>)
          }
        </div>
      </Suspense>
    </div>
